Implemented Algorithms (by publication date)
--------------------------------------------

- [`RandomBeamforming`](RandomBeamforming.m)
- [`ClosedForm3Users`](ClosedForm3Users.m)
...
- [`AlternatingMaxSR`](AlternatingMaxSR.m) + [`AlternatingMaxPower`](AlternatingMaxPower.m)
...
- [`AlternatingMinLeakage`](AlternatingMinLeakage.m) + [`AlternatingMaxSINR`](AlternatingMaxSINR.m)
...
- [`RankConstrainedRankMinimization`](RankConstrainedRankMinimization.m)
...
- [`AlternatingMinLeakageStructuredChannel`](AlternatingMinLeakageStructuredChannel.m)
...
- [`HybridSignalInterferenceAligment`](HybridSignalInterferenceAligment.m)
